...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=C8861A&center=true&vCenter=true&width=650&lines=Cybersecurity+Engineer;Cloud+Security+%7C+IAM+%7C+DevSecOps;Securing+Financial+Technology;Building+from+Yaound%C3%A9+to+the+World" alt="Typing SVG" />

# Ismaël Ariel Kagou Manga

**Cybersecurity Engineer · Cloud Security · Application & API Security**

*Working at the intersection of cloud security and finance*
...
[![Gmail](https://img.shields.io/badge/Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:ismaelkagou@gmail.com)
...
🔗 [Repository](https://github.com/letschangeAfrica/JobSeekers_Analytics-using-Machine-Learning)
...
```text
Security       IAM · RBAC · JWT/OAuth2 · DevSecOps · threat modeling · zero-trust
Cloud          AWS (EC2, S3, IAM, Lambda) · Docker · Linux · CI/CD
Languages      Python · JavaScript · Java · C · SQL · Bash
Backend        Django · DRF · FastAPI · Spring Boot
Frontend       React · Next.js · Tailwind CSS
Data           PostgreSQL · MongoDB · Pandas · scikit-learn
```
...
**Open to remote freelance and internship opportunities in cloud security, application security, and secure backend engineering.**

*Africa gave me the hunger. ALX gave me the discipline. The rest, I build myself.*
